...
async function run() {
  try {
    const userCollection = client.db("Hakim").collection("HakimData");
    const userCollections = client.db("Hakim").collection("HakimData1");
    const userCollectionCode = client.db("Hakim").collection("HakimDataCode");
    const userCollectionNewPassword = client
      .db("Hakim")
      .collection("HakimDataNewPassword");
